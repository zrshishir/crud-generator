        ...
        <div class="max-w-2xl mx-auto">
            ...
            <form action="{{ route('Orders.update', $Order) }}" method="POST" class="space-y-4">
                ...
                @method('PUT')
                    ...
                    <input name="order_number" id="order_number" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ $Order->order_number }}">
                    </input>
                    @error('order_number')
                    ...
                    <select name="status" id="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        <option value="pendin" {{ $Order->status == 'pendin' ? 'selected' : '' }}>pendin</option>
